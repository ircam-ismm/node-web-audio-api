...
// WARNING: Do not implment as class naively
// cf. https://github.com/ircam-ismm/node-web-audio-api/issues/118
// Further tests in this direction should be carefuly audited
