...
const rpiHostname = process.env.RPI_32_HOSTNAME;
const rpiUser = process.env.RPI_32_USER;
const rpiPrivKey = process.env.RPI_32_PRIVKEY;
const rpiCwd = process.env.RPI_32_CWD;
...
res = await conn.execCommand(`arm-linux-gnueabihf-strip ${binaryFilename}`, { cwd: rpiCwd });
logResult(res);
